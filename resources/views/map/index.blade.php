...
<div class="container" style="padding:2rem 2rem;">
    <div class="section-header-modern">
        <div class="header-left">
            ...
            <div class="header-text">
                ...
                <p class="section-description">Explore the campus and see available facilities on the map.</p>
            </div>
        </div>
    ...
    <div style="margin-top:1rem;">
        ...
        <!-- Map container -->
        <div id="schoolMap" style="width:100%; height:600px; border-radius:8px; overflow:hidden; box-shadow:var(--shadow-md);"></div>
        <!-- Leaflet JS -->
        ...
        <script>
            (function(){
                ...
                const map = L.map('schoolMap').setView([schoolLat, schoolLng], 17);
                ...
                L.marker([schoolLat, schoolLng], {icon: campusIcon}).addTo(map)
                    .bindPopup('<strong>School Campus</strong><br/>Main Campus').openPopup();
                ...
                facilities.forEach(function(f){
                    if (f.latitude && f.longitude) {
                        ...
                        marker.bindPopup(`<strong>${f.name}</strong><br/>${f.location || ''}`);
                    }
                });
                ...
                <div class="col-md-6 mb-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted">
                                <i class="fas fa-map-marker-alt"></i> Lat: {{ $facility->latitude }}, Lng: {{ $facility->longitude }}
                            </p>
                            <a href="{{ route('facilities.show', $facility->id) }}" class="btn btn-sm btn-primary">View Details</a>
                        </div>
                    </div>
                </div>
                @endforeach
