                ...
                <div class="card-body">
                    <form action="{{ route('facilities.update', $facility) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('location') is-invalid @enderror" id="location" name="location" value="{{ old('location', $facility->location) }}" placeholder="e.g., Building A, Room 101" required>
