...
<div class="full-screen-inbox">
    <div class="inbox-top-bar">
        ...
        <div>
            <a href="{{ route('admin.dashboard') }}" class="btn-action-view text-decoration-none" style="#1a3a52">
        ...
        @else
            <table class="table-full">
                ...
                <tbody>
                    ...
                    <tr class="{{ is_null($message->read_at) ? 'row-unread' : '' }} open-message" 
                        ...
                        <td class="col-sender">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div style="min-width: 0;">
                                    <div class="text-dark text-truncate-custom">{{ $message->name }}</div>
                                    <div class="text-muted small text-truncate-custom">{{ $message->email }}</div>
                                </div>
                            </div>
                        </td>

                        <td class="col-content">
                            <div class="text-dark fw-bold mb-0 text-truncate-custom">{{ $message->subject }}</div>
                        ...
                        <td class="col-date">
                            <div class="small text-dark">{{ $message->created_at->format('M d, Y') }}</div>
                            <div class="text-muted" style="font-size: 0.75rem;">{{ $message->created_at->diffForHumans() }}</div>
                        </td>
