            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <th>Facility:</th>
                            <td><strong>{{ $reservation->facility->name }}</strong></td>
                        </tr>
                        <tr>
                            <th>Guest Name:</th>
                        ...
                        <tr>
                            ...
                            <td>{{ $reservation->available_date ? $reservation->available_date->format('M d, Y') : 'Not specified' }}</td>
                        </tr>
                        <tr>
                            <th>Status:</th>
                            <td>
                        ...
                        <tr>
                            <th>Description:</th>
                            <td style="white-space: pre-wrap;">{{ $reservation->description }}</td>
                        </tr>
                        <tr>
                            <th>Notes:</th>
                            <td style="white-space: pre-wrap;">{{ $reservation->notes ?? 'No notes' }}</td>
                        </tr>
                        <tr>
                            <th>Submitted:</th>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <th>Capacity:</th>
                            <td>{{ $reservation->facility->capacity }} people</td>
                        </tr>
                        <tr>
                            <th>Available Hours:</th>
                            <td>{{ $reservation->facility->available_hours }} hours</td>
                        </tr>
                        <tr>
                            <th>Status:</th>
                            <td>
                        ...
                        <tr>
                            <td colspan="2">
                                <p style="white-space: pre-wrap;">{{ $reservation->facility->description }}</p>
                            </td>
                        </tr>
                    </table>
                </div>
        ...
        <div class="col-lg-6">
            <div class="card mb-4">
                ...
                <div class="card-body" style="padding: 0;">
                    @if($reservation->facility->latitude && $reservation->facility->longitude)
                        <div id="reservationMap" style="height: 500px;"></div>
                        
                        <div class="p-3">
                            <div class="alert alert-info mb-0">
                                <p class="mb-1"><strong>Coordinates:</strong></p>
                                <p class="mb-1">Latitude: {{ $reservation->facility->latitude }}</p>
                                <p class="mb-0">Longitude: {{ $reservation->facility->longitude }}</p>
                            </div>
                        </div>
                        ...
                        <script>
                            ...
                            const facilityLat = {{ $reservation->facility->latitude }};
                            const facilityLng = {{ $reservation->facility->longitude }};
                            ...
                            L.marker([facilityLat, facilityLng], {icon: facilityIcon})
                                .addTo(map)
                                .bindPopup(`\n                                    <div style="min-width: 260px; font-family: 'Poppins', sans-serif;">\n                                        <div style="background: linear-gradient(135deg, #1a3a52 0%, #2d5a7b 100%); color: white; padding: 12px; border-radius: 4px 4px 0 0; margin: -4px -4px 12px -4px;">\n                                            <h6 style="margin: 0; font-size: 15px; font-weight: 700;"><i class="fas fa-door-open"></i> {{ $reservation->facility->name }}</h6>\n                                        </div>\n                                        <p style="margin: 0 0 8px 0; font-size: 12px; color: #555;"><i class="fas fa-building"></i> <strong>Facility Type:</strong> Reserved</p>\n                                        <div style="border-left: 3px solid #d4af37; padding-left: 12px; margin: 10px 0;">\n                                            <p style="margin: 5px 0; font-size: 12px;"><i class="fas fa-map-marker-alt"></i> <strong>Address:</strong> {{ $reservation->facility->location }}</p>\n                                            <p style="margin: 5px 0; font-size: 12px;"><i class="fas fa-users"></i> <strong>Capacity:</strong> {{ $reservation->facility->capacity }} people</p>\n                                            <p style="margin: 5px 0; font-size: 12px;"><i class="fas fa-clock"></i> <strong>Hours:</strong> {{ $reservation->facility->available_hours }} hours/day</p>\n                                            <p style="margin: 5px 0 10px 0; font-size: 11px; color: #666;"><strong>📍 Coordinates:</strong><br/>Lat: {{ $reservation->facility->latitude }}<br/>Lng: {{ $reservation->facility->longitude }}</p>\n                                        </div>\n                                    </div>\n                                `);
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <a href="https://www.google.com/maps/dir/{{ $reservation->facility->latitude }},{{ $reservation->facility->longitude }}" 
                       target="_blank" class="btn btn-primary w-100 mb-2">
                        <i class="fas fa-directions"></i> Get Directions (Google Maps)
                    </a>
                    <a href="https://www.openstreetmap.org/?mlat={{ $reservation->facility->latitude }}&mlon={{ $reservation->facility->longitude }}&zoom=18" 
