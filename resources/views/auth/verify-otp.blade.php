    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
                ...
                <div class="card-body p-5">
                    ...
                    <div class="text-center mt-5">
                        ...
                        <div id="resend-section" class="d-none">
                            ...
                            <a href="{{ route('login.otp.resend') }}" class="text-primary text-decoration-none small fw-bold">
            ...
            <div class="text-center mt-4">
                <a href="{{ route('login') }}" class="text-muted text-decoration-none small mx-2">
