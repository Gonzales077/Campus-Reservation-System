                ...
                <div id="otpSection" class="d-none">
                    ...
                    <div class="mt-4 text-center">
                        ...
                        <div id="resend-link" class="d-none">
                            <a href="<?php echo e(route('login.otp.resend')); ?>" class="small fw-bold text-decoration-none" style="color: #2d5473;">Resend Code</a>
                        </div>
                    </div>
                </div>
...
document.getElementById('loginForm').addEventListener('submit', function(e) {
    ...
    fetch("<?php echo e(route('login')); ?>", {
        method: "POST",
        headers: { "X-CSRF-TOKEN": "<?php echo e(csrf_token()); ?>", "X-Requested-With": "XMLHttpRequest", "Content-Type": "application/json" },
...
document.getElementById('otpForm').addEventListener('submit', function(e) {
    ...
    fetch("<?php echo e(route('login.otp.verify')); ?>", {
        method: "POST",
        headers: { "X-CSRF-TOKEN": "<?php echo e(csrf_token()); ?>", "X-Requested-With": "XMLHttpRequest", "Content-Type": "application/json" },
                ...
                <div class="modal-body">
                    ...
                    <form action="<?php echo e(route('register')); ?>" method="POST">
                        ...
                        <div class="form-group-modal">
                            ...
                            <input type="email" id="register-gmail" name="gmail_address" placeholder="your.email@gmail.com" required value="<?php echo e(old('gmail_address')); ?>">
