    ...
    <div class="dashboard-section">
        ...
        <div class="facility-grid-modern" id="facilityGrid">
            ...
            <div class="facility-card-modern"
                 ...
                 data-description="<?php echo e(strtolower($facility->description ?? '')); ?>"
                 data-capacity="<?php echo e($facility->capacity); ?>">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <?php if(!empty($facility->images) && is_array($facility->images)): ?>
                            <button type="button" class="btn btn-sm btn-outline-secondary facility-gallery-btn ms-2"
                                    data-facility-name="<?php echo e($facility->name); ?>"
                                    data-images='<?php echo json_encode($facility->images, 15, 512) ?>'>
    ...
    <div class="dashboard-section">
        ...
        <div class="reservations-timeline" id="reservationList">
            ...
            <div class="reservation-card"
                 ...
                 data-facility="<?php echo e(strtolower($reservation->facility->name)); ?>"
                 data-description="<?php echo e(strtolower($reservation->description ?? '')); ?>"
                 data-date="<?php echo e($reservation->created_at->timestamp); ?>">
                <div class="reservation-status-indicator status-<?php echo e($reservation->status); ?>-bar"></div>
                ...
                <div class="reservation-content">
                    ...
                    <div class="reservation-details">
                        <div class="detail-group">
                            <div class="detail-row">
                                ...
                                <div class="detail-value"><?php echo e(Str::limit($reservation->description, 80)); ?></div>
                            </div>
                    ...
                    <div class="reservation-footer">
                        <a href="<?php echo e(route('reservations.show', $reservation)); ?>" class="btn-view-details">
...
<div id="schoolMapModal" style="display:none;position:fixed;inset:0;background:rgba(2,6,23,0.6);z-index:1200;align-items:center;justify-content:center;padding:20px;">
    <div style="width:100%;max-width:920px;max-height:80vh;background:linear-gradient(180deg,#ffffff,#f8fafc);border-radius:12px;box-shadow:0 10px 40px rgba(2,6,23,0.6);position:relative;overflow:hidden;display:flex;flex-direction:column;">
        ...
        <div style="padding:12px;display:flex;align-items:center;justify-content:center;flex:1;overflow:auto;">
            <img id="schoolMapImage" src="<?php echo e(asset('images/schoolmap.png')); ?>" alt="School Map"
