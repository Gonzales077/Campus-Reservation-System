...
unset($__errorArgs, $__bag); ?>" id="name" name="name" required>
                            ...
                            <?php $__currentLoopData = $facilityNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facilityName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($facilityName); ?>" <?php echo e(old('name') === $facilityName ? 'selected' : ''); ?>><?php echo e($facilityName); ?></option>
...
unset($__errorArgs, $__bag); ?>" id="location" name="location" value="<?php echo e(old('location')); ?>" placeholder="e.g. Building A, 2nd Floor" required>
...
unset($__errorArgs, $__bag); ?>" id="description" name="description" rows="4" placeholder="Describe the facility features..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="p-3 border rounded-4 bg-light">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="capacity" name="capacity" value="<?php echo e(old('capacity')); ?>" min="1" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="p-3 border rounded-4 bg-light">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="available_hours" name="available_hours" value="<?php echo e(old('available_hours')); ?>" min="1" required>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end gap-3 mt-5">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn-back d-flex align-items-center">Cancel</a>
...
<script>
    ...
    <?php if(session('toast_success')): ?>
        Toast.fire({ icon: 'success', title: "<?php echo e(session('toast_success')); ?>" });
    <?php endif; ?>

    <?php if(session('toast_error')): ?>
        Toast.fire({ icon: 'error', title: "<?php echo e(session('toast_error')); ?>" });
    <?php endif; ?>
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\my-project\resources\views/facilities/create.blade.php ENDPATH**/ ?>