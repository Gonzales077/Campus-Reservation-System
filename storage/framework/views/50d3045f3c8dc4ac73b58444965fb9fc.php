...
unset($__errorArgs, $__bag); ?>" id="capacity" name="capacity" value="<?php echo e(old('capacity')); ?>" min="1" required>
...
unset($__errorArgs, $__bag); ?>" id="available_hours" name="available_hours" value="<?php echo e(old('available_hours')); ?>" min="1" required>
