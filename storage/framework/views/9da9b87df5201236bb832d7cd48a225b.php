...
<div class="hcc-dashboard-wrapper">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <div class="header-main-info">
                    ...
                    <h1 class="hcc-title">
                        <i class="fas fa-ribbon me-2 gold-text"></i>Reservation <span class="fw-light">#<?php echo e($reservation->id); ?></span>
                    </h1>
                    <p class="hcc-subtitle">Management portal for facility booking and guest coordination.</p>
                </div>
                <div class="header-actions">
                    <a href="<?php echo e(route('user.dashboard')); ?>" class="btn btn-hcc-outline-gold">
                ...
                <div class="card hcc-card status-banner-card mb-4">
                    <div class="card-body d-flex align-items-center justify-content-between p-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="mb-0 fw-bold"><?php echo e($reservation->facility->name ?? 'Facility Reference'); ?></h4>
                        ...
                        <div class="status-badge-wrapper">
                            ...
                            ?>
                            <span class="hcc-badge-lg <?php echo e($currentClass); ?>">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-4">
                            <div class="col-md-6 detail-item">
                                ...
                                <p><?php echo e($reservation->guest_name ?? 'N/A'); ?></p>
                            </div>
                            <div class="col-md-6 detail-item">
                                <label>Contact Information</label>
                                <p><?php echo e($reservation->guest_contact ?? 'N/A'); ?></p>
                            </div>
                            <div class="col-md-6 detail-item">
                                <label>Estimated Participants</label>
                                <p class="fw-bold"><i class="fas fa-users me-2 text-muted"></i><?php echo e($reservation->estimated_participants ?? '0'); ?> Persons</p>
                            </div>
                           <div class="col-md-6 detail-item">
    ...
    <p class="hcc-blue-text fw-bold">
        ...
        <?php echo e($reservation->available_date ? \Carbon\Carbon::parse($reservation->available_date)->format('F j, Y') : 'Pending Admin Approval'); ?>

    </p>
</div>
                            <div class="col-md-12 detail-item">
                                <label>Submission Timestamp</label>
                                <p class="small text-muted"><i class="fas fa-clock me-2"></i><?php echo e($reservation->created_at ? $reservation->created_at->format('M d, Y | g:i A') : 'N/A'); ?></p>
                            </div>
                            ...
                            <div class="col-12 detail-item mt-2">
                                ...
                                <div class="hcc-well">
                                    <i class="fas fa-quote-left me-2 opacity-25"></i><?php echo e($reservation->description); ?>
            ...
            <div class="col-lg-4">
                <div class="card hcc-card facility-sidebar sticky-top" style="top: 20px; z-index: 10;">
                    ...
                    <?php if($reservation->facility): ?>
                    <div class="card-body p-4">
                        <ul class="list-unstyled hcc-list mb-4">
                            <li class="d-flex justify-content-between">
                                <span class="text-muted">Location</span>
                                <strong><?php echo e($reservation->facility->location); ?></strong>
                            </li>
                            <li class="d-flex justify-content-between">
                                <span class="text-muted">Capacity</span>
                                <strong><?php echo e($reservation->facility->capacity); ?> Persons</strong>
                            </li>
                            <li class="d-flex justify-content-between">
                                <span class="text-muted">Hours</span>
                                <strong><?php echo e($reservation->facility->available_hours); ?> Hours/Day</strong>
                            </li>
                        </ul>
                        <div class="facility-status-box text-center">
                            <span class="small text-muted d-block mb-2">Current Facility Status</span>
                            <span class="badge <?php echo e($reservation->facility->status === 'active' ? 'bg-success' : 'bg-dark'); ?> w-100 py-2">
                                <?php echo e(strtoupper($reservation->facility->status)); ?>
                ...
                <div class="card hcc-card mt-4 border-hcc-blue">
                    <div class="card-body p-3">
                        ...
                        <a href="mailto:<?php echo e($reservation->guest_contact ?? ''); ?>" class="btn btn-outline-secondary w-100">
