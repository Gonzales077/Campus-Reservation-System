...
<div class="admin-dashboard-container">
        ...
        <div class="header-gradient-overlay">
            <div class="header-content-wrapper">
                ...
                <div class="header-right">
                    ...
                    <a href="<?php echo e(route('admin.messages.index')); ?>" class="header-action-btn ms-2 position-relative" style="background:#fff; color:#333;">
                        <div class="btn-icon-wrapper">
                        ...
                        <div class="btn-content">
                            ...
                            <?php if(isset($unreadMessagesCount) && $unreadMessagesCount > 0): ?>
                                <span class="message-badge" style="display:inline-block;background:#e53935;color:#fff;padding:2px 6px;border-radius:12px;margin-left:8px;font-size:12px;"><?php echo e($unreadMessagesCount); ?></span>
                            <?php endif; ?>
                        </div>
                    </a>
                </div>
    ...
    <?php if(session('success')): ?>
        <div class="notification-card notification-success">
            ...
            <div class="notification-content">
                <p class="notification-message"><?php echo e(session('success')); ?></p>
            </div>
    ...
    <?php if(session('error')): ?>
        <div class="notification-card notification-error">
            ...
            <div class="notification-content">
                <p class="notification-message"><?php echo e(session('error')); ?></p>
            </div>
            <button class="notification-close">
                <i class="fas fa-times"></i>
            </button>
        ...
        <div class="stats-grid-modern">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-progress">
                        <div class="progress-bar">
                            <div class="progress-fill" style="width: <?php echo e($pendingReservations->count() > 0 ? '80%' : '0%'); ?>"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="stat-card-modern stat-success">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-progress">
                        <div class="progress-bar">
                            <div class="progress-fill" style="width: <?php echo e($approvedReservations->count() > 0 ? '60%' : '0%'); ?>"></div>
                        </div>
                    </div>
                </div>
                <div class="stat-footer">
            ...
            <div class="stat-card-modern stat-primary">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-progress">
                        <div class="progress-bar">
                            <div class="progress-fill" style="width: <?php echo e($facilities->where('status', 'active')->count() / max($facilities->count(), 1) * 100); ?>%"></div>
                        </div>
                    </div>
                </div>
                <div class="stat-footer">
            ...
            <div class="stat-card-modern stat-secondary">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-progress">
                        <div class="progress-bar">
                            <div class="progress-fill" style="width: <?php echo e($allReservations->count() > 0 ? '40%' : '0%'); ?>"></div>
                        </div>
                    </div>
                </div>
                <div class="stat-footer">
        ...
        <div class="section-header-modern">
            ...
            <div class="section-actions-modern">
                <span class="status-count-badge badge-warning">
                    <i class="fas fa-clock"></i>
                    <?php echo e($pendingReservations->count()); ?> Pending
                </span>
                    ...
                    <tr>
                            ...
                            <div class="facility-info">
                                ...
                                <div class="facility-meta">
                                    <span class="facility-meta-item">
                                        ...
                                        <?php echo e($reservation->facility->capacity); ?>
                        ...
                        <td class="table-col-contact">
                            <div class="contact-info">
                                <a href="tel:<?php echo e($reservation->guest_contact); ?>" class="contact-link">
                                    <i class="fas fa-phone"></i>
                                    <?php echo e($reservation->guest_contact); ?>
                        ...
                        <td class="table-col-description">
                            <div class="description-content">
                                <?php echo e(Str::limit($reservation->description, 60)); ?>
                ...
                <form action="<?php echo e(route('reservations.approve', $reservation)); ?>" method="POST">
                    ...
                    <div class="modal-body-custom">
                        ...
                        <div class="form-group-custom">
                            <label for="available_date<?php echo e($reservation->id); ?>">
                                <i class="fas fa-calendar-alt"></i> Available Date *
                            </label>
                            <input type="date" class="form-control-custom" id="available_date<?php echo e($reservation->id); ?>" name="available_date" min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>" required>
        ...
        <div class="section-header-modern">
            ...
            <div class="section-actions-modern">
                <span class="status-count-badge badge-success">
                    <i class="fas fa-check-circle"></i>
                    <?php echo e($approvedReservations->count()); ?> Active
                </span>
            </div>
        </div>
            ...
            <table class="modern-admin-table">
                ...
                <tbody>
                    ...
                    <tr>
                            ...
                            <div class="facility-info">
                                ...
                                <div class="facility-meta">
                                    <span class="facility-meta-item">
                                        ...
                                        <?php echo e($reservation->facility->location); ?>
                        ...
                        <td class="table-col-description">
                            <div class="description-content">
                                <?php echo e(Str::limit($reservation->description, 50)); ?>
                            ...
                            <div class="date-display-modern">
                                ...
                                <div class="date-info">
                                    <div class="date-value">
                                        <?php echo e($reservation->available_date ? $reservation->available_date->format('M d, Y') : 'Not set'); ?>

                                    </div>
                                    <?php if($reservation->available_date): ?>
                                    <div class="date-remaining">
                                        <?php echo e(\Carbon\Carbon::parse($reservation->available_date)->diffForHumans()); ?>
    ...
    <div class="modern-section-card" id="facilities-section">
        <div class="section-header-modern">
            ...
            <div class="section-actions-modern">
                <a href="<?php echo e(route('facilities.create')); ?>" class="primary-action-btn">
                    <i class="fas fa-plus"></i>
            ...
            <div class="facility-card-modern">
                <div class="facility-card-header">
                    ...
                    <div class="facility-actions-dropdown">
                        ...
                        <div class="dropdown-menu-facility">
                            <a href="<?php echo e(route('facilities.edit', $facility)); ?>" class="dropdown-item">
                ...
                <div class="facility-card-body">
                    ...
                    <div class="facility-location">
                        <i class="fas fa-map-marker-alt"></i>
                        <span><?php echo e($facility->location); ?></span>
                    </div>
                    <div class="facility-details-grid">
                        <div class="detail-item">
                            ...
                            <div class="detail-content">
                                <div class="detail-value"><?php echo e($facility->capacity); ?></div>
                        ...
                        <div class="detail-item">
                            ...
                            <div class="detail-content">
                                <div class="detail-value"><?php echo e($facility->available_hours); ?></div>
                ...
                <div class="facility-card-footer">
                    <div class="reservation-count">
                        ...
                        <span><?php echo e($facility->reservations->count()); ?> reservations</span>
                    </div>
                    <a href="<?php echo e(route('facilities.edit', $facility)); ?>" class="edit-facility-btn">
                        <i class="fas fa-edit"></i>
                        <span>Manage</span>
                    </a>
                </div>
        ...
        <div class="empty-state-modern">
            ...
            <a href="<?php echo e(route('facilities.create')); ?>" class="primary-action-btn empty-state-btn">
    ...
    <div class="modern-section-card" id="all-reservations">
        <div class="section-header-modern">
            ...
            <div class="section-actions-modern">
                ...
                <span class="status-count-badge">
                    <i class="fas fa-list"></i>
                    <?php echo e($allReservations->count()); ?> Total
                </span>
            </div>
        </div>
                        ...
                        <td class="table-col-date">
                            <div class="date-display-modern">
                                ...
                                <div class="date-info">
                                    ...
                                    <div class="date-ago">
                                        <?php echo e($reservation->created_at->diffForHumans()); ?>
        ...
        <div class="table-footer">
            <div class="pagination-info">
                Showing <?php echo e($allReservations->count()); ?> of <?php echo e($allReservations->count()); ?> reservations
            </div>
